  ...
  const faqData = [
    {
      ...
      a: 'Пошлина зависит от возраста авто, типа двигателя (ДВС, гибрид, электро) и объема двигателя. Для физлиц выгоднее всего везти машины в возрасте от 3 до 5 лет. Мы берем все расчеты и таможенное оформление под свой полный контроль.'
    },
    {
    ...
    },
    {
      ...
      a: 'Оплата производится поэтапно: 1) Депозит 100 000 руб. при подписании договора на подбор, 2) Оплата стоимости авто на аукционе банковским переводом, 3) Оплата таможни и доставки по прибытии авто во Владивосток или на границу.'
    },
    {
      q: 'Где забирать готовый автомобиль?',
      a: `Наш главный филиал выдачи находится по адресу: ${appTexts.showroomAddress}. Мы проводим полную предпродажную подготовку, детейлинг и вручаем авто. Также отправляем автовозами в Москву, СПб, Екатеринбург и любой другой город РФ.`
    }
  ];
      ...
      <div className="px-4 mt-6">
        ...
        <div className="bg-white rounded-3xl border border-[#EFEBE4] overflow-hidden p-4 space-y-3.5 shadow-md">
          ...
          <div className="flex items-start space-x-3 text-xs border-t border-[#EFEBE4]/40 pt-3.5">
            ...
            <div>
              <h4 className="font-bold text-[#1C1917]">Наш офис</h4>
              <p className="text-[10px] text-[#78716C] leading-normal mt-0.5 font-sans font-medium">
                Приезжайте знакомиться лично! {appTexts.showroomAddress}. Рады видеть вас каждый день с 10:00 до 17:00.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="bg-[#C5A880]/10 border border-[#C5A880]/30 rounded-2xl p-3.5 mb-2.5 space-y-2 shrink-0">
                ...
                <p className="text-[8.5px] text-[#78716C] leading-normal font-medium">
                  Оставьте ваш телефон, чтобы получить детальный подбор и расчет моделей под ваш персональный бюджет в течение 30 минут!
                </p>
                  ...
                  <button
                    onClick={() => {
                      ...
                      setConsultationChat(prev => [
                        ...
                        { sender: 'manager', text: `Спасибо! Ваша заявка принята. Менеджер уже готовит лучшие варианты подбора под ваш бюджет для номера ${phone}!` }
                      ]);
                      inp.value = '';
